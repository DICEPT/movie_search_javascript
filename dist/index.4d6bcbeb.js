...
var _maincore = require("./core/maincore");
class App extends (0, _maincore.Component) {
    render() {
...
},{"./core/maincore":"70vns","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"70vns":[function(require,module,exports) {
...
exports.default = (0, _maincore.createRouter)([
    {
        path: "#/",
...
},{"../core/maincore":"70vns","./Home":"0JSNG","./Movie":"1LTyN","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"0JSNG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _maincore = require("../core/maincore");
...
class Home extends (0, _maincore.Component) {
    render() {
...
},{"../core/maincore":"70vns","../components/Headline":"gaVgo","../components/Search":"jqPPz","../components/MovieList":"8UDl3","../components/MovieListMore":"3ZUar","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gaVgo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _maincore = require("../core/maincore");
class Headline extends (0, _maincore.Component) {
    render() {
...
},{"../core/maincore":"70vns","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jqPPz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _maincore = require("../core/maincore");
var _movie = require("../store/movie");
var _movieDefault = parcelHelpers.interopDefault(_movie);
class Search extends (0, _maincore.Component) {
    render() {
...
},{"../core/maincore":"70vns","../store/movie":"kq1bo","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kq1bo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "searchMovies", ()=>searchMovies);
parcelHelpers.export(exports, "getMovieDetails", ()=>getMovieDetails);
var _maincore = require("../core/maincore");
const store = new (0, _maincore.Store)({
    search: "",
    page: 1,
    pageMax: 1,
    movies: [],
...
const searchMovies = async (page)=>{
    store.state.loading = true; // searchMovies가 실행되면 loading값이 true가 된다.
    ...
    try {
        ...
        store.state.loading = false; // 영화 정보를 모두 가져오고 loading값이 false가 된다.
    }
};
...
},{"../core/maincore":"70vns","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8UDl3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _maincore = require("../core/maincore");
var _movie = require("../store/movie");
...
class MovieList extends (0, _maincore.Component) {
    constructor(){
        super();
    ...
    render() {
        ...
        const loaderEl = this.el.querySelector(".dot-pulse");
        (0, _movieDefault.default).state.loading ? loaderEl.classList.remove("hide") : loaderEl.classList.add("hide");
    }
}
exports.default = MovieList;

},{"../core/maincore":"70vns","../store/movie":"kq1bo","./MovieItem":"fAzE8","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fAzE8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _maincore = require("../core/maincore");
class MovieItem extends (0, _maincore.Component) {
    constructor(props){
        super({
            props,
            tagName: "a"
...
},{"../core/maincore":"70vns","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3ZUar":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _maincore = require("../core/maincore");
var _movie = require("../store/movie");
var _movieDefault = parcelHelpers.interopDefault(_movie);
class MovieListMore extends (0, _maincore.Component) {
    constructor(){
        super({
            tagName: "button"
        });
        (0, _movieDefault.default).subscribe("pageMax", ()=>{
            const { pageMax , page  } = (0, _movieDefault.default).state;
...
},{"../core/maincore":"70vns","../store/movie":"kq1bo","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1LTyN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _maincore = require("../core/maincore");
var _movie = require("../store/movie");
var _movieDefault = parcelHelpers.interopDefault(_movie);
class Movie extends (0, _maincore.Component) {
    async render() {
...
},{"../core/maincore":"70vns","../store/movie":"kq1bo","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["e11Rl","gLLPy"], "gLLPy", "parcelRequirea814")
